...
function addTimeAvailability(elem) {
    ...
    removeButton.onclick = function() {elem.parentElement.parentElement.removeChild(div)}
...
function sendHomeworkAvailabilityTimes() {
    if (document.querySelector("form").isValid) modal.hide();
}